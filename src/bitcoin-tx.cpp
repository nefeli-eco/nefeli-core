...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nefelicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nefelicoin-tx [options] <hex-tx> [commands]  Update hex-encoded nefelicoin transaction\n" +
            "or:     nefelicoin-tx [options] -create [commands]   Create hex-encoded nefelicoin transaction\n" +
            "\n";
