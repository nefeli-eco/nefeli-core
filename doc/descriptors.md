# Support for Output Descriptors in Nefelicoin Core

Since Nefelicoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Nefelicoin Core wallets, a convenience function `combo` is
