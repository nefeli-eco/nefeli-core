...
"""Verify that starting nefelicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nefelicoin with -h for help text")
        ...
        self.log.info("Start nefelicoin with -version for version information")
        ...
        self.log.info("Start nefelicoind with -fakearg to make sure it does not start")
