Contributing to Nefelicoin Core
============================

The Nefelicoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Nefelicoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/nefelicoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to nefelicoin-qt
...
The following applies to code changes to the Nefelicoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Nefelicoin
Network Protocol consensus changes.

Whether a pull request is merged into Nefelicoin Core rests with the project merge
...
Patches that change Nefelicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nefelicoin consensus, it must have been
...
The project leader is the release manager for each Nefelicoin Core release.
